...
export class AffiliatesApi extends runtime.BaseAPI {
     ...
     */
    async getAffiliatesRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AffiliateStanding>> {
     ...
     * Answers the caller org\'s OWN affiliate standing: status, referral code and share link, commission rate, how many orgs it has referred, and its lifetime accrued, still-pending and already-paid commission in integer cents, with its payout history.
     */
    async getAffiliates(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AffiliateStanding> {
        const response = await this.getAffiliatesRaw(initOverrides);
     ...
     */
    async getAffiliatesLeaderboardRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AffiliateBoard>> {
        const queryParameters: any = {};
        ...
        let urlPath = `/v1/affiliates/leaderboard`;
     ...
     * Answers the top affiliates by lifetime accrued commission, shown by OPT-IN HANDLE with aggregate figures only, plus the caller\'s own exact rank.
     */
    async getAffiliatesLeaderboard(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AffiliateBoard> {
        const response = await this.getAffiliatesLeaderboardRaw(initOverrides);
        return await response.value();
    }
     ...
     */
    async getAffiliatesMeRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AffiliateSelf>> {
        const queryParameters: any = {};
     ...
     * Answers the richer self-view: the same lifetime accrued, pending and paid commission and payout history, plus the caller\'s downline broken out by upline LEVEL — direct, second, third — each with the rate paid at that level and how many orgs sit there.
     */
    async getAffiliatesMe(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AffiliateSelf> {
        const response = await this.getAffiliatesMeRaw(initOverrides);
        return await response.value();
    }
     ...
     */
    async getAffiliatesMeEarningsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AffiliateEarnings>> {
        const queryParameters: any = {};
        ...
        let urlPath = `/v1/affiliates/me/earnings`;
     ...
     * Answers the caller\'s own commission ledger: per period, the margin it earned against and the commission taken from that margin; and per referred org, that referral\'s aggregate contribution.
     */
    async getAffiliatesMeEarnings(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AffiliateEarnings> {
        const response = await this.getAffiliatesMeEarningsRaw(initOverrides);
        return await response.value();
    }
     ...
     */
    async getAffiliatesMeLinksRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AffiliateLinks>> {
        const queryParameters: any = {};
        ...
        let urlPath = `/v1/affiliates/me/links`;
     ...
     * Answers the caller\'s share links, each with its URL and its funnel: clicks tracked, signups — orgs attributed with that code — and conversions, meaning how many of those signups have actually produced commission.
     */
    async getAffiliatesMeLinks(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AffiliateLinks> {
        const response = await this.getAffiliatesMeLinksRaw(initOverrides);
        return await response.value();
    }
     ...
     */
    async postAffiliatesApplyRaw(requestParameters: AffiliatesApiPostAffiliatesApplyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Application>> {
        if (requestParameters['applyRequest'] == null) {
            throw new runtime.RequiredError(
                'applyRequest',
                'Required parameter "applyRequest" was null or undefined when calling postAffiliatesApply().'
            );
        }
        ...
        let urlPath = `/v1/affiliates/apply`;
     ...
     * Enrolls the caller\'s OWN org as an affiliate at status `applied`, optionally requesting a vanity code, and answers the record — 201 on the first apply, 200 with `created:false` afterwards.
     */
    async postAffiliatesApply(requestParameters: AffiliatesApiPostAffiliatesApplyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Application> {
        const response = await this.postAffiliatesApplyRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async postAffiliatesAttributeRaw(requestParameters: AffiliatesApiPostAffiliatesAttributeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Attribution>> {
        if (requestParameters['attributeRequest'] == null) {
            throw new runtime.RequiredError(
                'attributeRequest',
                'Required parameter "attributeRequest" was null or undefined when calling postAffiliatesAttribute().'
            );
        }
        ...
        let urlPath = `/v1/affiliates/attribute`;
     ...
     * Records the first-touch edge every later commission is computed from: the caller\'s org was referred by the affiliate that owns this code.
     */
    async postAffiliatesAttribute(requestParameters: AffiliatesApiPostAffiliatesAttributeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Attribution> {
        const response = await this.postAffiliatesAttributeRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async postAffiliatesClickRaw(requestParameters: AffiliatesApiPostAffiliatesClickRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ClickCount>> {
        if (requestParameters['clickRequest'] == null) {
            throw new runtime.RequiredError(
                'clickRequest',
                'Required parameter "clickRequest" was null or undefined when calling postAffiliatesClick().'
            );
        }
        ...
        let urlPath = `/v1/affiliates/click`;
     ...
     * Counts a click on a share link.
     */
    async postAffiliatesClick(requestParameters: AffiliatesApiPostAffiliatesClickRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ClickCount> {
        const response = await this.postAffiliatesClickRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async postAffiliatesMeHandleRaw(requestParameters: AffiliatesApiPostAffiliatesMeHandleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<HandleSet>> {
        if (requestParameters['handleRequest'] == null) {
            throw new runtime.RequiredError(
                'handleRequest',
                'Required parameter "handleRequest" was null or undefined when calling postAffiliatesMeHandle().'
            );
        }
        ...
        let urlPath = `/v1/affiliates/me/handle`;
     ...
     * Sets the caller\'s public leaderboard display name, or clears it.
     */
    async postAffiliatesMeHandle(requestParameters: AffiliatesApiPostAffiliatesMeHandleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<HandleSet> {
        const response = await this.postAffiliatesMeHandleRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async postAffiliatesMeLinksRaw(requestParameters: AffiliatesApiPostAffiliatesMeLinksRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<LinkMint>> {
        if (requestParameters['createLinkRequest'] == null) {
            throw new runtime.RequiredError(
                'createLinkRequest',
                'Required parameter "createLinkRequest" was null or undefined when calling postAffiliatesMeLinks().'
            );
        }
     ...
     * Mints a new share link for the caller\'s own affiliate and answers it with its full URL, 201.
     */
    async postAffiliatesMeLinks(requestParameters: AffiliatesApiPostAffiliatesMeLinksRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<LinkMint> {
        const response = await this.postAffiliatesMeLinksRaw(requestParameters, initOverrides);
        return await response.value();
    }
