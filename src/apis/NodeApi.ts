...
export class NodeApi extends runtime.BaseAPI {
     ...
     */
    async getNodeRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<NodesView>> {
     ...
     * Returns the caller org\'s currently connected bot nodes: what each one calls itself, the platform it runs on, its agent version, when its socket was established, and the capabilities and commands it reported.
     */
    async getNode(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<NodesView> {
        const response = await this.getNodeRaw(initOverrides);
     ...
     */
    async getNodeConnectRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const queryParameters: any = {};
     ...
     * The socket a bot node dials and holds open to become invokable.
     */
    async getNodeConnect(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.getNodeConnectRaw(initOverrides);
    }
     ...
     */
    async postNodeByIdInvokeRaw(requestParameters: NodeApiPostNodeByIdInvokeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling postNodeByIdInvoke().'
            );
        }
     ...
     * Ask one of your connected machines to run a command, and get its answer back.
     */
    async postNodeByIdInvoke(requestParameters: NodeApiPostNodeByIdInvokeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.postNodeByIdInvokeRaw(requestParameters, initOverrides);
    }
     ...
     */
    async postNodePeerInvokeRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const queryParameters: any = {};
        ...
        let urlPath = `/v1/node/peer/invoke`;
     ...
     * Replica-to-replica forward of one invocation to the pod holding the node\'s socket.
     */
    async postNodePeerInvoke(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.postNodePeerInvokeRaw(initOverrides);
    }
