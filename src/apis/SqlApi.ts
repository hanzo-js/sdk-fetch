...
export class SqlApi extends runtime.BaseAPI {
     ...
     */
    async deleteSqlByNameRaw(requestParameters: SqlApiDeleteSqlByNameRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['name'] == null) {
            throw new runtime.RequiredError(
                'name',
                'Required parameter "name" was null or undefined when calling deleteSqlByName().'
            );
        }
     ...
     * DropSQL deprovisions one Hanzo SQL database.
     */
    async deleteSqlByName(requestParameters: SqlApiDeleteSqlByNameRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.deleteSqlByNameRaw(requestParameters, initOverrides);
    }
     ...
     */
    async getSqlRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<ProvisionedSummary>>> {
        const queryParameters: any = {};
     ...
     * ListSQL lists the caller org\'s Hanzo SQL databases.
     */
    async getSql(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<ProvisionedSummary>> {
        const response = await this.getSqlRaw(initOverrides);
     ...
     */
    async getSqlByNameRaw(requestParameters: SqlApiGetSqlByNameRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ProvisionedResource>> {
        if (requestParameters['name'] == null) {
            throw new runtime.RequiredError(
                'name',
                'Required parameter "name" was null or undefined when calling getSqlByName().'
            );
        }
     ...
     * GetSQL returns one Hanzo SQL database\'s metadata.
     */
    async getSqlByName(requestParameters: SqlApiGetSqlByNameRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ProvisionedResource> {
        const response = await this.getSqlByNameRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async postSqlRaw(requestParameters: SqlApiPostSqlRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ProvisionResult>> {
        const queryParameters: any = {};
     ...
     * Provision a PostgreSQL database for your org
     */
    async postSql(requestParameters: SqlApiPostSqlRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ProvisionResult> {
        const response = await this.postSqlRaw(requestParameters, initOverrides);
        return await response.value();
    }
