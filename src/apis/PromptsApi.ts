...
export class PromptsApi extends runtime.BaseAPI {
     ...
     */
    async deletePromptsByNameRaw(requestParameters: PromptsApiDeletePromptsByNameRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['name'] == null) {
            throw new runtime.RequiredError(
                'name',
                'Required parameter "name" was null or undefined when calling deletePromptsByName().'
            );
        }
     ...
     * Delete removes one of the caller org\'s prompts and every version of it, answering 204.
     */
    async deletePromptsByName(requestParameters: PromptsApiDeletePromptsByNameRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.deletePromptsByNameRaw(requestParameters, initOverrides);
    }
     ...
     */
    async getPromptsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PromptList>> {
        const queryParameters: any = {};
     ...
     * List returns the caller org\'s prompt library as one row per prompt: its name, type, every version number it has, its taxonomy and when it last changed.
     */
    async getPrompts(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PromptList> {
     ...
     */
    async getPromptsByNameRaw(requestParameters: PromptsApiGetPromptsByNameRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PromptDetail>> {
        if (requestParameters['name'] == null) {
            throw new runtime.RequiredError(
                'name',
                'Required parameter "name" was null or undefined when calling getPromptsByName().'
            );
        }
     ...
     * Get returns one of the caller org\'s prompts: its CURRENT template text plus the metadata of every version it has had.
     */
    async getPromptsByName(requestParameters: PromptsApiGetPromptsByNameRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PromptDetail> {
        const response = await this.getPromptsByNameRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getPromptsCatalogRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CatalogList>> {
        const queryParameters: any = {};
        ...
        let urlPath = `/v1/prompts/catalog`;
     ...
     * Catalog returns the read-only starter prompt library shipped with the binary — reference content every tenant sees the same, NOT the caller\'s own prompts and never mixed into them.
     */
    async getPromptsCatalog(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CatalogList> {
        const response = await this.getPromptsCatalogRaw(initOverrides);
        return await response.value();
    }
     ...
     */
    async getPromptsMetricsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MetricList>> {
        const queryParameters: any = {};
        ...
        let urlPath = `/v1/prompts/metrics`;
     ...
     * Metrics returns real per-prompt statistics for the caller\'s org: how many versions each prompt has, which one is current, and when it was created and last changed.
     */
    async getPromptsMetrics(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MetricList> {
        const response = await this.getPromptsMetricsRaw(initOverrides);
        return await response.value();
    }
     ...
     */
    async postPromptsRaw(requestParameters: PromptsApiPostPromptsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PromptDetail>> {
        if (requestParameters['promptReq'] == null) {
            throw new runtime.RequiredError(
                'promptReq',
                'Required parameter "promptReq" was null or undefined when calling postPrompts().'
            );
        }
     ...
     * Create records a prompt for the caller\'s org and answers 201 with it.
     */
    async postPrompts(requestParameters: PromptsApiPostPromptsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PromptDetail> {
        const response = await this.postPromptsRaw(requestParameters, initOverrides);
        return await response.value();
    }
