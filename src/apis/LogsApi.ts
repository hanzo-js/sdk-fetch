...
export class LogsApi extends runtime.BaseAPI {
     ...
     */
    async getLogsHealthRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
     ...
     * How many log records this deployment holds for your org
     */
    async getLogsHealth(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.getLogsHealthRaw(initOverrides);
    }
     ...
     */
    async getLogsQueryRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const queryParameters: any = {};
     ...
     * Search your org\'s logs by label, time and substring
     */
    async getLogsQuery(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.getLogsQueryRaw(initOverrides);
    }
     ...
     */
    async postLogsWriteRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const queryParameters: any = {};
     ...
     * Append structured log records for your org
     */
    async postLogsWrite(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.postLogsWriteRaw(initOverrides);
    }
