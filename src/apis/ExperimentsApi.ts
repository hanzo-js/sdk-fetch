...
import {
    ...
    DecideBodyFromJSON,
    DecideBodyToJSON,
    ExperimentListFromJSON,
    ExperimentListToJSON,
    HealthFromJSON,
    HealthToJSON,
    TrialFromJSON,
    TrialToJSON,
...
export class ExperimentsApi extends runtime.BaseAPI {
     ...
     */
    async getExperimentsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ExperimentList>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ExperimentListFromJSON(jsonValue));
    }
     ...
     * Is every experiment in the caller\'s org, with its variants, status and decision, ordered by project then id.
     */
    async getExperiments(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ExperimentList> {
        const response = await this.getExperimentsRaw(initOverrides);
     ...
     */
    async getExperimentsByIdRaw(requestParameters: ExperimentsApiGetExperimentsByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Trial>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling getExperimentsById().'
            );
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => TrialFromJSON(jsonValue));
    }
     ...
     * Is one experiment\'s definition and lifecycle: variants, weights, control arm, status and winner.
     */
    async getExperimentsById(requestParameters: ExperimentsApiGetExperimentsByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Trial> {
        const response = await this.getExperimentsByIdRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getExperimentsByIdAssignRaw(requestParameters: ExperimentsApiGetExperimentsByIdAssignRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Assignment>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling getExperimentsByIdAssign().'
            );
        }
        ...
        if (requestParameters['subject'] == null) {
            throw new runtime.RequiredError(
                'subject',
                'Required parameter "subject" was null or undefined when calling getExperimentsByIdAssign().'
            );
        }
        ...
        if (requestParameters['props'] != null) {
            queryParameters['props'] = requestParameters['props'];
        }
        ...
        let urlPath = `/v1/experiments/{id}/assign`;
        urlPath = urlPath.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters['id'])));
     ...
     * Is the variant one subject is bucketed into, and the payload that variant carries.
     */
    async getExperimentsByIdAssign(requestParameters: ExperimentsApiGetExperimentsByIdAssignRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Assignment> {
        const response = await this.getExperimentsByIdAssignRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getExperimentsHealthRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Health>> {
        const queryParameters: any = {};
        ...
        let urlPath = `/v1/experiments/health`;
     ...
     * Is whether the experiments subsystem is mounted and serving in this process.
     */
    async getExperimentsHealth(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Health> {
        const response = await this.getExperimentsHealthRaw(initOverrides);
        return await response.value();
    }
     ...
     */
    async postExperimentsRaw(requestParameters: ExperimentsApiPostExperimentsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Trial>> {
        if (requestParameters['createBody'] == null) {
            throw new runtime.RequiredError(
                'createBody',
                'Required parameter "createBody" was null or undefined when calling postExperiments().'
            );
        }
     ...
     * Registers a controlled experiment AND puts its assignment flag live, in that order, so the arms start bucketing subjects the moment this returns 201 — the flag is created active at 100% rollout, with each variant weighted as declared.
     */
    async postExperiments(requestParameters: ExperimentsApiPostExperimentsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Trial> {
        const response = await this.postExperimentsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async postExperimentsByIdAnalyzeRaw(requestParameters: ExperimentsApiPostExperimentsByIdAnalyzeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Analysis>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling postExperimentsByIdAnalyze().'
            );
        }

        if (requestParameters['analyzeQuery'] == null) {
            throw new runtime.RequiredError(
                'analyzeQuery',
                'Required parameter "analyzeQuery" was null or undefined when calling postExperimentsByIdAnalyze().'
            );
        }
        ...
        let urlPath = `/v1/experiments/{id}/analyze`;
        urlPath = urlPath.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters['id'])));
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: AnalyzeQueryToJSON(requestParameters['analyzeQuery']),
        }, initOverrides);
     ...
     * Is per-variant conversion, lift and statistical significance against the control arm.
     */
    async postExperimentsByIdAnalyze(requestParameters: ExperimentsApiPostExperimentsByIdAnalyzeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Analysis> {
        const response = await this.postExperimentsByIdAnalyzeRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Promotes one variant to the whole rollout and records who decided.
     */
    async postExperimentsByIdDecideRaw(requestParameters: ExperimentsApiPostExperimentsByIdDecideRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Trial>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling postExperimentsByIdDecide().'
            );
        }

        if (requestParameters['decideBody'] == null) {
            throw new runtime.RequiredError(
                'decideBody',
                'Required parameter "decideBody" was null or undefined when calling postExperimentsByIdDecide().'
            );
        }
        ...
        let urlPath = `/v1/experiments/{id}/decide`;
        urlPath = urlPath.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters['id'])));
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: DecideBodyToJSON(requestParameters['decideBody']),
        }, initOverrides);
     ...
     * Promotes one variant to the whole rollout and records who decided.
     */
    async postExperimentsByIdDecide(requestParameters: ExperimentsApiPostExperimentsByIdDecideRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Trial> {
        const response = await this.postExperimentsByIdDecideRaw(requestParameters, initOverrides);
        return await response.value();
    }
