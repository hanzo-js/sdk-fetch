...
export class ReferralApi extends runtime.BaseAPI {
     ...
     */
    async getReferralRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MyReferrals>> {
     ...
     * Returns the caller\'s referral code, share link and the referrals they have made.
     */
    async getReferral(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<MyReferrals> {
     ...
     */
    async postReferralClaimRaw(requestParameters: ReferralApiPostReferralClaimRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ClaimView>> {
        if (requestParameters['claimRequest'] == null) {
            throw new runtime.RequiredError(
                'claimRequest',
                'Required parameter "claimRequest" was null or undefined when calling postReferralClaim().'
            );
        }
     ...
     * Records that the caller\'s org signed up through a referral code.
     */
    async postReferralClaim(requestParameters: ReferralApiPostReferralClaimRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ClaimView> {
        const response = await this.postReferralClaimRaw(requestParameters, initOverrides);
        return await response.value();
    }
