...
export class ExperimentApi extends runtime.BaseAPI {
     ...
     */
    async getExperimentRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ExperimentList>> {
     ...
     * Is every experiment in the caller\'s org, with its variants, status and decision, ordered by project then id.
     */
    async getExperiment(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ExperimentList> {
        const response = await this.getExperimentRaw(initOverrides);
     ...
     */
    async getExperimentByIdRaw(requestParameters: ExperimentApiGetExperimentByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Trial>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling getExperimentById().'
            );
        }
     ...
     * Is one experiment\'s definition and lifecycle: variants, weights, control arm, status and winner.
     */
    async getExperimentById(requestParameters: ExperimentApiGetExperimentByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Trial> {
        const response = await this.getExperimentByIdRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getExperimentByIdAssignRaw(requestParameters: ExperimentApiGetExperimentByIdAssignRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Assignment>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling getExperimentByIdAssign().'
            );
        }
        ...
        if (requestParameters['subject'] == null) {
            throw new runtime.RequiredError(
                'subject',
                'Required parameter "subject" was null or undefined when calling getExperimentByIdAssign().'
            );
        }
        ...
        let urlPath = `/v1/experiment/{id}/assign`;
        urlPath = urlPath.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters['id'])));
     ...
     * Is the variant one subject is bucketed into, and the payload that variant carries.
     */
    async getExperimentByIdAssign(requestParameters: ExperimentApiGetExperimentByIdAssignRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Assignment> {
        const response = await this.getExperimentByIdAssignRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getExperimentHealthRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Health>> {
        const queryParameters: any = {};
        ...
        let urlPath = `/v1/experiment/health`;
     ...
     * Is whether the experiments subsystem is mounted and serving in this process.
     */
    async getExperimentHealth(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Health> {
        const response = await this.getExperimentHealthRaw(initOverrides);
        return await response.value();
    }
     ...
     */
    async postExperimentRaw(requestParameters: ExperimentApiPostExperimentRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Trial>> {
        if (requestParameters['createBody'] == null) {
            throw new runtime.RequiredError(
                'createBody',
                'Required parameter "createBody" was null or undefined when calling postExperiment().'
            );
        }
     ...
     * Registers a controlled experiment AND puts its assignment flag live, in that order, so the arms start bucketing subjects the moment this returns 201 — the flag is created active at 100% rollout, with each variant weighted as declared.
     */
    async postExperiment(requestParameters: ExperimentApiPostExperimentRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Trial> {
        const response = await this.postExperimentRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async postExperimentByIdAnalyzeRaw(requestParameters: ExperimentApiPostExperimentByIdAnalyzeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Analysis>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling postExperimentByIdAnalyze().'
            );
        }
        ...
        if (requestParameters['analyzeQuery'] == null) {
            throw new runtime.RequiredError(
                'analyzeQuery',
                'Required parameter "analyzeQuery" was null or undefined when calling postExperimentByIdAnalyze().'
            );
        }
        ...
        let urlPath = `/v1/experiment/{id}/analyze`;
        urlPath = urlPath.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters['id'])));
     ...
     * Is per-variant conversion, lift and statistical significance against the control arm.
     */
    async postExperimentByIdAnalyze(requestParameters: ExperimentApiPostExperimentByIdAnalyzeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Analysis> {
        const response = await this.postExperimentByIdAnalyzeRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Promotes one variant to the whole rollout and records who decided.
     */
    async postExperimentByIdDecideRaw(requestParameters: ExperimentApiPostExperimentByIdDecideRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Trial>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling postExperimentByIdDecide().'
            );
        }
        ...
        if (requestParameters['decideBody'] == null) {
            throw new runtime.RequiredError(
                'decideBody',
                'Required parameter "decideBody" was null or undefined when calling postExperimentByIdDecide().'
            );
        }
        ...
        let urlPath = `/v1/experiment/{id}/decide`;
        urlPath = urlPath.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters['id'])));
     ...
     * Promotes one variant to the whole rollout and records who decided.
     */
    async postExperimentByIdDecide(requestParameters: ExperimentApiPostExperimentByIdDecideRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Trial> {
        const response = await this.postExperimentByIdDecideRaw(requestParameters, initOverrides);
        return await response.value();
    }
