 ...
 * 
 */
export class DocdbApi extends runtime.BaseAPI {
     ...
     */
    async deleteDocdbByNameRaw(requestParameters: DocdbApiDeleteDocdbByNameRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['name'] == null) {
            throw new runtime.RequiredError(
                'name',
                'Required parameter "name" was null or undefined when calling deleteDocdbByName().'
            );
        }
     ...
     * DropDocDB deprovisions one Hanzo DocDB database.
     */
    async deleteDocdbByName(requestParameters: DocdbApiDeleteDocdbByNameRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.deleteDocdbByNameRaw(requestParameters, initOverrides);
    }
     ...
     */
    async getDocdbRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<ProvisionedSummary>>> {
        const queryParameters: any = {};
     ...
     * ListDocDB lists the caller org\'s Hanzo DocDB document databases.
     */
    async getDocdb(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<ProvisionedSummary>> {
        const response = await this.getDocdbRaw(initOverrides);
     ...
     */
    async getDocdbByNameRaw(requestParameters: DocdbApiGetDocdbByNameRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ProvisionedResource>> {
        if (requestParameters['name'] == null) {
            throw new runtime.RequiredError(
                'name',
                'Required parameter "name" was null or undefined when calling getDocdbByName().'
            );
        }
     ...
     * GetDocDB returns one Hanzo DocDB database\'s metadata.
     */
    async getDocdbByName(requestParameters: DocdbApiGetDocdbByNameRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ProvisionedResource> {
        const response = await this.getDocdbByNameRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async postDocdbRaw(requestParameters: DocdbApiPostDocdbRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ProvisionResult>> {
        const queryParameters: any = {};
     ...
     * Provision a document database for your org
     */
    async postDocdb(requestParameters: DocdbApiPostDocdbRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ProvisionResult> {
        const response = await this.postDocdbRaw(requestParameters, initOverrides);
        return await response.value();
    }
