...
/**
 * Check if a given object implements the DeclareEnv interface.
 */
export function instanceOfDeclareEnv(value: object): value is DeclareEnv {
    return true;
}

export function DeclareEnvFromJSON(json: any): DeclareEnv {
    return DeclareEnvFromJSONTyped(json, false);
}

export function DeclareEnvFromJSONTyped(json: any, ignoreDiscriminator: boolean): DeclareEnv {
    if (json == null) {
        return json;
    }
    return {
...
export function DeclareEnvToJSON(json: any): DeclareEnv {
    return DeclareEnvToJSONTyped(json, false);
}

export function DeclareEnvToJSONTyped(value?: DeclareEnv | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
