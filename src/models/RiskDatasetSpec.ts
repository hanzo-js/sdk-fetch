...
/**
 * Check if a given object implements the RiskDatasetSpec interface.
 */
export function instanceOfRiskDatasetSpec(value: object): value is RiskDatasetSpec {
    return true;
}

export function RiskDatasetSpecFromJSON(json: any): RiskDatasetSpec {
    return RiskDatasetSpecFromJSONTyped(json, false);
}

export function RiskDatasetSpecFromJSONTyped(json: any, ignoreDiscriminator: boolean): RiskDatasetSpec {
    if (json == null) {
        return json;
    }
    return {
        
        'cuts': json['cuts'] == null ? undefined : json['cuts'],
...
export function RiskDatasetSpecToJSON(json: any): RiskDatasetSpec {
    return RiskDatasetSpecToJSONTyped(json, false);
}

export function RiskDatasetSpecToJSONTyped(value?: RiskDatasetSpec | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
