...
import type { RiskLabelResult } from './RiskLabelResult.js';
import {
    RiskLabelResultFromJSON,
    RiskLabelResultFromJSONTyped,
    RiskLabelResultToJSON,
    RiskLabelResultToJSONTyped,
} from './RiskLabelResult.js';
...
/**
 * Check if a given object implements the RiskLabelOut interface.
 */
export function instanceOfRiskLabelOut(value: object): value is RiskLabelOut {
    return true;
}

export function RiskLabelOutFromJSON(json: any): RiskLabelOut {
    return RiskLabelOutFromJSONTyped(json, false);
}

export function RiskLabelOutFromJSONTyped(json: any, ignoreDiscriminator: boolean): RiskLabelOut {
    if (json == null) {
        return json;
    }
    return {
        ...
        'mirror': json['mirror'] == null ? undefined : json['mirror'],
        ...
        'results': json['results'] == null ? undefined : ((json['results'] as Array<any>).map(RiskLabelResultFromJSON)),
    };
}

export function RiskLabelOutToJSON(json: any): RiskLabelOut {
    return RiskLabelOutToJSONTyped(json, false);
}

export function RiskLabelOutToJSONTyped(value?: RiskLabelOut | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'results': value['results'] == null ? undefined : ((value['results'] as Array<any>).map(RiskLabelResultToJSON)),
    };
}
