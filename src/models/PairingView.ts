...
/**
 * Check if a given object implements the PairingView interface.
 */
export function instanceOfPairingView(value: object): value is PairingView {
    return true;
}

export function PairingViewFromJSON(json: any): PairingView {
    return PairingViewFromJSONTyped(json, false);
}

export function PairingViewFromJSONTyped(json: any, ignoreDiscriminator: boolean): PairingView {
    if (json == null) {
        return json;
    }
    return {
...
export function PairingViewToJSON(json: any): PairingView {
    return PairingViewToJSONTyped(json, false);
}

export function PairingViewToJSONTyped(value?: PairingView | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
