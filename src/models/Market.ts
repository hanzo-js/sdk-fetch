...
export function MarketFromJSONTyped(json: any, ignoreDiscriminator: boolean): Market {
    ...
    return {
        ...
        'amm': json['amm'] == null ? undefined : json['amm'],
        'coin': json['coin'] == null ? undefined : json['coin'],
        'day': json['day'] == null ? undefined : DayFromJSON(json['day']),
        'factory': json['factory'] == null ? undefined : json['factory'],
        'figures': json['figures'] == null ? undefined : FiguresFromJSON(json['figures']),
...
export function MarketToJSONTyped(value?: Market | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'figures': FiguresToJSON(value['figures']),
        'graph': value['graph'],
        'id': value['id'],
        'name': value['name'],
