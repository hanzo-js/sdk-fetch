...
/**
 * Check if a given object implements the RiskResolved interface.
 */
export function instanceOfRiskResolved(value: object): value is RiskResolved {
    return true;
}

export function RiskResolvedFromJSON(json: any): RiskResolved {
    return RiskResolvedFromJSONTyped(json, false);
}

export function RiskResolvedFromJSONTyped(json: any, ignoreDiscriminator: boolean): RiskResolved {
    if (json == null) {
        return json;
    }
    return {
        ...
        'conflicts': json['conflicts'] == null ? undefined : ((json['conflicts'] as Array<any>).map(RiskLabelRecordFromJSON)),
...
export function RiskResolvedToJSON(json: any): RiskResolved {
    return RiskResolvedToJSONTyped(json, false);
}

export function RiskResolvedToJSONTyped(value?: RiskResolved | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'conflicts': value['conflicts'] == null ? undefined : ((value['conflicts'] as Array<any>).map(RiskLabelRecordToJSON)),
