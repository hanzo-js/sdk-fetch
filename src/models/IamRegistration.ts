...
/**
 * Check if a given object implements the IamRegistration interface.
 */
export function instanceOfIamRegistration(value: object): value is IamRegistration {
    return true;
}

export function IamRegistrationFromJSON(json: any): IamRegistration {
    return IamRegistrationFromJSONTyped(json, false);
}

export function IamRegistrationFromJSONTyped(json: any, ignoreDiscriminator: boolean): IamRegistration {
    if (json == null) {
        return json;
    }
    return {
...
export function IamRegistrationToJSON(json: any): IamRegistration {
    return IamRegistrationToJSONTyped(json, false);
}

export function IamRegistrationToJSONTyped(value?: IamRegistration | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
