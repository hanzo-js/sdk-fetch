...
/**
 * Check if a given object implements the RiskDisposeOut interface.
 */
export function instanceOfRiskDisposeOut(value: object): value is RiskDisposeOut {
    return true;
}

export function RiskDisposeOutFromJSON(json: any): RiskDisposeOut {
    return RiskDisposeOutFromJSONTyped(json, false);
}

export function RiskDisposeOutFromJSONTyped(json: any, ignoreDiscriminator: boolean): RiskDisposeOut {
    if (json == null) {
        return json;
    }
    return {
...
export function RiskDisposeOutToJSON(json: any): RiskDisposeOut {
    return RiskDisposeOutToJSONTyped(json, false);
}

export function RiskDisposeOutToJSONTyped(value?: RiskDisposeOut | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
