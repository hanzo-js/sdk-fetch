...
/**
 * Check if a given object implements the RiskLabelFact interface.
 */
export function instanceOfRiskLabelFact(value: object): value is RiskLabelFact {
    return true;
}

export function RiskLabelFactFromJSON(json: any): RiskLabelFact {
    return RiskLabelFactFromJSONTyped(json, false);
}

export function RiskLabelFactFromJSONTyped(json: any, ignoreDiscriminator: boolean): RiskLabelFact {
    if (json == null) {
        return json;
    }
    return {
...
export function RiskLabelFactToJSON(json: any): RiskLabelFact {
    return RiskLabelFactToJSONTyped(json, false);
}

export function RiskLabelFactToJSONTyped(value?: RiskLabelFact | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
