...
import type { RiskSurface } from './RiskSurface.js';
import {
    RiskSurfaceFromJSON,
    RiskSurfaceFromJSONTyped,
    RiskSurfaceToJSON,
    RiskSurfaceToJSONTyped,
} from './RiskSurface.js';
...
import type { RiskAggregates } from './RiskAggregates.js';
import {
    RiskAggregatesFromJSON,
    RiskAggregatesFromJSONTyped,
    RiskAggregatesToJSON,
    RiskAggregatesToJSONTyped,
} from './RiskAggregates.js';
...
/**
 * Check if a given object implements the RiskModelState interface.
 */
export function instanceOfRiskModelState(value: object): value is RiskModelState {
    return true;
}

export function RiskModelStateFromJSON(json: any): RiskModelState {
    return RiskModelStateFromJSONTyped(json, false);
}

export function RiskModelStateFromJSONTyped(json: any, ignoreDiscriminator: boolean): RiskModelState {
    if (json == null) {
        return json;
    }
    return {
        
        'aggregates': json['aggregates'] == null ? undefined : RiskAggregatesFromJSON(json['aggregates']),
        'blind': json['blind'] == null ? undefined : json['blind'],
        'cut': json['cut'] == null ? undefined : json['cut'],
        'descends': json['descends'] == null ? undefined : json['descends'],
        ...
        'surface': json['surface'] == null ? undefined : RiskSurfaceFromJSON(json['surface']),
        'tenant': json['tenant'] == null ? undefined : json['tenant'],
        'values': json['values'] == null ? undefined : ((json['values'] as Array<any>).map(RiskModelValueFromJSON)),
        'warm': json['warm'] == null ? undefined : json['warm'],
    };
}

export function RiskModelStateToJSON(json: any): RiskModelState {
    return RiskModelStateToJSONTyped(json, false);
}

export function RiskModelStateToJSONTyped(value?: RiskModelState | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'aggregates': RiskAggregatesToJSON(value['aggregates']),
        'blind': value['blind'],
        'cut': value['cut'],
        'descends': value['descends'],
        ...
        'shape': value['shape'],
        'stated': value['stated'],
        'surface': RiskSurfaceToJSON(value['surface']),
        'tenant': value['tenant'],
        'values': value['values'] == null ? undefined : ((value['values'] as Array<any>).map(RiskModelValueToJSON)),
        'warm': value['warm'],
    };
}
