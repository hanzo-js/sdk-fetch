...
/**
 * Check if a given object implements the PayoutView interface.
 */
export function instanceOfPayoutView(value: object): value is PayoutView {
    return true;
}

export function PayoutViewFromJSON(json: any): PayoutView {
    return PayoutViewFromJSONTyped(json, false);
}

export function PayoutViewFromJSONTyped(json: any, ignoreDiscriminator: boolean): PayoutView {
    if (json == null) {
        return json;
    }
    return {
...
export function PayoutViewToJSON(json: any): PayoutView {
    return PayoutViewToJSONTyped(json, false);
}

export function PayoutViewToJSONTyped(value?: PayoutView | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
