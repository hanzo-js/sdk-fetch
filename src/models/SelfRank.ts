...
/**
 * Check if a given object implements the SelfRank interface.
 */
export function instanceOfSelfRank(value: object): value is SelfRank {
    return true;
}

export function SelfRankFromJSON(json: any): SelfRank {
    return SelfRankFromJSONTyped(json, false);
}

export function SelfRankFromJSONTyped(json: any, ignoreDiscriminator: boolean): SelfRank {
    if (json == null) {
        return json;
    }
    return {
        ...
        'ofTotal': json['ofTotal'] == null ? undefined : json['ofTotal'],
        'rank': json['rank'] == null ? undefined : json['rank'],
        'ranked': json['ranked'] == null ? undefined : json['ranked'],
        'requests': json['requests'] == null ? undefined : json['requests'],
        'tokens': json['tokens'] == null ? undefined : json['tokens'],
    };
}

export function SelfRankToJSON(json: any): SelfRank {
    return SelfRankToJSONTyped(json, false);
}

export function SelfRankToJSONTyped(value?: SelfRank | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
