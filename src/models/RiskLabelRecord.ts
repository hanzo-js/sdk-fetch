...
/**
 * Check if a given object implements the RiskLabelRecord interface.
 */
export function instanceOfRiskLabelRecord(value: object): value is RiskLabelRecord {
    return true;
}

export function RiskLabelRecordFromJSON(json: any): RiskLabelRecord {
    return RiskLabelRecordFromJSONTyped(json, false);
}

export function RiskLabelRecordFromJSONTyped(json: any, ignoreDiscriminator: boolean): RiskLabelRecord {
    if (json == null) {
        return json;
    }
    return {
...
export function RiskLabelRecordToJSON(json: any): RiskLabelRecord {
    return RiskLabelRecordToJSONTyped(json, false);
}

export function RiskLabelRecordToJSONTyped(value?: RiskLabelRecord | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
