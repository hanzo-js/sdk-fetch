...
import type { RiskValue } from './RiskValue.js';
import {
    RiskValueFromJSON,
    RiskValueFromJSONTyped,
    RiskValueToJSON,
    RiskValueToJSONTyped,
} from './RiskValue.js';
import type { RiskCause } from './RiskCause.js';
import {
    RiskCauseFromJSON,
    RiskCauseFromJSONTyped,
    RiskCauseToJSON,
    RiskCauseToJSONTyped,
} from './RiskCause.js';
...
/**
 * Check if a given object implements the RiskScoreOut interface.
 */
export function instanceOfRiskScoreOut(value: object): value is RiskScoreOut {
    return true;
}

export function RiskScoreOutFromJSON(json: any): RiskScoreOut {
    return RiskScoreOutFromJSONTyped(json, false);
}

export function RiskScoreOutFromJSONTyped(json: any, ignoreDiscriminator: boolean): RiskScoreOut {
    if (json == null) {
        return json;
    }
    return {
        ...
        'causes': json['causes'] == null ? undefined : ((json['causes'] as Array<any>).map(RiskCauseFromJSON)),
        ...
        'values': json['values'] == null ? undefined : ((json['values'] as Array<any>).map(RiskValueFromJSON)),
    };
}

export function RiskScoreOutToJSON(json: any): RiskScoreOut {
    return RiskScoreOutToJSONTyped(json, false);
}

export function RiskScoreOutToJSONTyped(value?: RiskScoreOut | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'alert': value['alert'],
        'causes': value['causes'] == null ? undefined : ((value['causes'] as Array<any>).map(RiskCauseToJSON)),
        'cut': value['cut'],
        'policy': value['policy'],
        ...
        'shadow': value['shadow'],
        'shape': value['shape'],
        'values': value['values'] == null ? undefined : ((value['values'] as Array<any>).map(RiskValueToJSON)),
    };
}
