 ...
 */
export function instanceOfSocialPost(value: object): value is SocialPost {
    return true;
}
...
export function SocialPostToJSON(json: any): SocialPost {
    return SocialPostToJSONTyped(json, false);
}

export function SocialPostToJSONTyped(value?: SocialPost | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
