...
/**
 * Check if a given object implements the RiskModelValue interface.
 */
export function instanceOfRiskModelValue(value: object): value is RiskModelValue {
    return true;
}

export function RiskModelValueFromJSON(json: any): RiskModelValue {
    return RiskModelValueFromJSONTyped(json, false);
}

export function RiskModelValueFromJSONTyped(json: any, ignoreDiscriminator: boolean): RiskModelValue {
    if (json == null) {
        return json;
    }
    return {
        ...
        'warmed': json['warmed'] == null ? undefined : json['warmed'],
    };
}

export function RiskModelValueToJSON(json: any): RiskModelValue {
    return RiskModelValueToJSONTyped(json, false);
}

export function RiskModelValueToJSONTyped(value?: RiskModelValue | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
