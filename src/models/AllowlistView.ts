...
/**
 * Check if a given object implements the AllowlistView interface.
 */
export function instanceOfAllowlistView(value: object): value is AllowlistView {
    return true;
}

export function AllowlistViewFromJSON(json: any): AllowlistView {
    return AllowlistViewFromJSONTyped(json, false);
}

export function AllowlistViewFromJSONTyped(json: any, ignoreDiscriminator: boolean): AllowlistView {
    if (json == null) {
        return json;
    }
    return {
...
export function AllowlistViewToJSON(json: any): AllowlistView {
    return AllowlistViewToJSONTyped(json, false);
}

export function AllowlistViewToJSONTyped(value?: AllowlistView | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
