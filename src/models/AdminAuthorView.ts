...
/**
 * Check if a given object implements the AdminAuthorView interface.
 */
export function instanceOfAdminAuthorView(value: object): value is AdminAuthorView {
    return true;
}

export function AdminAuthorViewFromJSON(json: any): AdminAuthorView {
    return AdminAuthorViewFromJSONTyped(json, false);
}

export function AdminAuthorViewFromJSONTyped(json: any, ignoreDiscriminator: boolean): AdminAuthorView {
    if (json == null) {
        return json;
    }
    return {
        ...
        'deployCount': json['deployCount'] == null ? undefined : json['deployCount'],
...
export function AdminAuthorViewToJSON(json: any): AdminAuthorView {
    return AdminAuthorViewToJSONTyped(json, false);
}

export function AdminAuthorViewToJSONTyped(value?: AdminAuthorView | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
