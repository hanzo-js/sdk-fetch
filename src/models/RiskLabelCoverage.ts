...
import type { RiskSourceCoverage } from './RiskSourceCoverage.js';
import {
    RiskSourceCoverageFromJSON,
    RiskSourceCoverageFromJSONTyped,
    RiskSourceCoverageToJSON,
    RiskSourceCoverageToJSONTyped,
} from './RiskSourceCoverage.js';
...
/**
 * Check if a given object implements the RiskLabelCoverage interface.
 */
export function instanceOfRiskLabelCoverage(value: object): value is RiskLabelCoverage {
    return true;
}

export function RiskLabelCoverageFromJSON(json: any): RiskLabelCoverage {
    return RiskLabelCoverageFromJSONTyped(json, false);
}

export function RiskLabelCoverageFromJSONTyped(json: any, ignoreDiscriminator: boolean): RiskLabelCoverage {
    if (json == null) {
        return json;
    }
    return {
        
        'contested': json['contested'] == null ? undefined : json['contested'],
        'events': json['events'] == null ? undefined : json['events'],
        'explore': json['explore'] == null ? undefined : json['explore'],
        ...
        'matured': json['matured'] == null ? undefined : json['matured'],
        'pending': json['pending'] == null ? undefined : json['pending'],
        'productive': json['productive'] == null ? undefined : json['productive'],
        'sources': json['sources'] == null ? undefined : ((json['sources'] as Array<any>).map(RiskSourceCoverageFromJSON)),
...
export function RiskLabelCoverageToJSON(json: any): RiskLabelCoverage {
    return RiskLabelCoverageToJSONTyped(json, false);
}

export function RiskLabelCoverageToJSONTyped(value?: RiskLabelCoverage | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'sources': value['sources'] == null ? undefined : ((value['sources'] as Array<any>).map(RiskSourceCoverageToJSON)),
        'to': value['to'],
