...
/**
 * Check if a given object implements the InboxView interface.
 */
export function instanceOfInboxView(value: object): value is InboxView {
    return true;
}

export function InboxViewFromJSON(json: any): InboxView {
    return InboxViewFromJSONTyped(json, false);
}

export function InboxViewFromJSONTyped(json: any, ignoreDiscriminator: boolean): InboxView {
    if (json == null) {
        return json;
    }
    return {
        ...
        'roomKind': json['roomKind'] == null ? undefined : json['roomKind'],
        'sender': json['sender'] == null ? undefined : json['sender'],
        'senderUser': json['senderUser'] == null ? undefined : json['senderUser'],
        'text': json['text'] == null ? undefined : json['text'],
    };
}

export function InboxViewToJSON(json: any): InboxView {
    return InboxViewToJSONTyped(json, false);
}

export function InboxViewToJSONTyped(value?: InboxView | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
