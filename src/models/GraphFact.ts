...
/**
 * Check if a given object implements the GraphFact interface.
 */
export function instanceOfGraphFact(value: object): value is GraphFact {
    return true;
}

export function GraphFactFromJSON(json: any): GraphFact {
    return GraphFactFromJSONTyped(json, false);
}

export function GraphFactFromJSONTyped(json: any, ignoreDiscriminator: boolean): GraphFact {
    if (json == null) {
        return json;
    }
    return {
...
export function GraphFactToJSON(json: any): GraphFact {
    return GraphFactToJSONTyped(json, false);
}

export function GraphFactToJSONTyped(value?: GraphFact | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
