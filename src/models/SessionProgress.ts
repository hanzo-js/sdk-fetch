...
/**
 * Check if a given object implements the SessionProgress interface.
 */
export function instanceOfSessionProgress(value: object): value is SessionProgress {
    return true;
}

export function SessionProgressFromJSON(json: any): SessionProgress {
    return SessionProgressFromJSONTyped(json, false);
}

export function SessionProgressFromJSONTyped(json: any, ignoreDiscriminator: boolean): SessionProgress {
    if (json == null) {
        return json;
    }
    return {
...
export function SessionProgressToJSON(json: any): SessionProgress {
    return SessionProgressToJSONTyped(json, false);
}

export function SessionProgressToJSONTyped(value?: SessionProgress | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
