...
/**
 * Check if a given object implements the TrustPublish interface.
 */
export function instanceOfTrustPublish(value: object): value is TrustPublish {
    return true;
}

export function TrustPublishFromJSON(json: any): TrustPublish {
    return TrustPublishFromJSONTyped(json, false);
}

export function TrustPublishFromJSONTyped(json: any, ignoreDiscriminator: boolean): TrustPublish {
    if (json == null) {
        return json;
    }
    return {
...
export function TrustPublishToJSON(json: any): TrustPublish {
    return TrustPublishToJSONTyped(json, false);
}

export function TrustPublishToJSONTyped(value?: TrustPublish | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
